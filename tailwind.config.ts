	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				...
				'feature-gradient': 'linear-gradient(135deg, rgba(124, 255, 83, 0.05) 0%, rgba(0, 0, 0, 0) 60%)',
				'glow-gradient': 'radial-gradient(circle at center, rgba(124, 255, 83, 0.3) 0%, rgba(124, 255, 83, 0) 70%)',
				'button-gradient': 'linear-gradient(to right, #7CFF53, #5EF533)'
			}
		}
	},
